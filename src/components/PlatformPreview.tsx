...
import { Heart, MessageCircle, Repeat2, Send, MoreHorizontal, Bookmark, Edit3, Settings, Wand2 } from 'lucide-react';
...
export default function PlatformPreview({ channel, content, onCopy, copied, onRegenerate, isRegenerating, metadata = {} }: PlatformPreviewProps) {
    ...
    <div className="bg-white rounded-lg border border-gray-200 shadow-sm max-w-lg mx-auto">
        ...
        <div className="flex items-start space-x-3">
          ...
          <div className="flex-1">
            <div className="flex items-center space-x-1">
              ...
              <div className="w-4 h-4 bg-blue-600 rounded-sm flex items-center justify-center ml-1">
      ...
      <div className="px-4 pb-4">
        ...
        <div className="flex items-center justify-around pt-2 border-t border-gray-100">
          <button className="flex items-center space-x-2 py-2 px-4 hover:bg-gray-50 rounded-lg transition-colors flex-1 justify-center group">
            <svg className="w-5 h-5 text-gray-600 group-hover:text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M14 10h4.764a2 2 0 011.789 2.894l-3.5 7A2 2 0 0115.263 21h-4.017c-.163 0-.326-.02-.485-.06L7 20m7-10V18m-7-8a2 2 0 01-2-2V7a2 2 0 012-2s0 0 0 0 1.796 0 2.5 0h1.5a2 2 0 012 2v1a2 2 0 01-2 2H9z" />
            </svg>
            <span className="text-sm text-gray-700 font-medium group-hover:text-blue-600">Like</span>
          </button>
          <button className="flex items-center space-x-2 py-2 px-4 hover:bg-gray-50 rounded-lg transition-colors flex-1 justify-center group">
            <svg className="w-5 h-5 text-gray-600 group-hover:text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
            </svg>
            <span className="text-sm text-gray-700 font-medium group-hover:text-blue-600">Comment</span>
          </button>
          <button className="flex items-center space-x-2 py-2 px-4 hover:bg-gray-50 rounded-lg transition-colors flex-1 justify-center group">
            <svg className="w-5 h-5 text-gray-600 group-hover:text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12" />
            </svg>
            <span className="text-sm text-gray-700 font-medium group-hover:text-blue-600">Repost</span>
          </button>
          <button className="flex items-center space-x-2 py-2 px-4 hover:bg-gray-50 rounded-lg transition-colors flex-1 justify-center group">
            <svg className="w-5 h-5 text-gray-600 group-hover:text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8" />
            </svg>
            <span className="text-sm text-gray-700 font-medium group-hover:text-blue-600">Send</span>
          </button>
        </div>
      </div>
    </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-4 shadow-sm">
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center space-x-2 mb-2">
                <span className="font-semibold text-gray-900 text-sm hover:underline cursor-pointer">
                  {editableMetadata.slack_username || editableMetadata.sender_name || 'Your Name'}
                </span>
            ...
            {isEditing ? (
              ...
              <div 
                className="text-gray-900 text-sm leading-relaxed whitespace-pre-wrap cursor-pointer hover:bg-gray-50 p-2 rounded transition-colors mb-3 break-words overflow-wrap-anywhere"
                onClick={() => setIsEditing(true)}
                title="Click to edit"
                dangerouslySetInnerHTML={{ 
              ...
              <div className="flex items-center space-x-3 mt-3 pt-2 border-t border-gray-100">
                ...
                <span className="text-xs text-gray-500">6 replies</span>
              </div>
            </div>
          </div>
        </div>
  ...
  const renderEmailPreview = () => {
    ...
    return (
      <div className="bg-white rounded-xl border border-gray-200 shadow-lg max-w-2xl mx-auto overflow-hidden">
        {/* Email Header */}
              ...
              <div className="prose prose-sm max-w-none">
                ...
                {editableMetadata.email_signature && (
                  <div className="mt-4 pt-4 border-t border-gray-200 text-gray-600" 
                       dangerouslySetInnerHTML={{ __html: editableMetadata.email_signature.replace(/\n/g, '<br>') }} />
                )}
              </div>
            </div>
          </div>
  ...
  return (
    <div className="space-y-4">
      <div className="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden">
        ...
        <div className="flex items-center justify-between p-3 border-b border-gray-100 bg-gray-50/50">
          ...
          <div className="flex items-center space-x-2">
            ...
            {onCopy && (
              <button
                onClick={onCopy}
                className={`px-3 h-8 rounded-md text-xs font-medium transition-all flex items-center justify-center ${
                  copied 
        ...
        <div className="p-4">
          {viewMode === 'mobile' ? (
            <div className="max-w-sm mx-auto bg-gray-900 p-2 rounded-2xl">
