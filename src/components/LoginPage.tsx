      ...
      <div className="max-w-sm w-full space-y-6 p-6">
        <div className="text-center">
          <div className="flex items-center justify-center space-x-2 mb-4">
            ...
            <h1 className="text-2xl font-semibold text-gray-900">ToneMagik</h1>
          </div>
          <p className="text-gray-600 text-sm">
            AI-powered tone rewriter for all your communication needs
          </p>
        </div>
        ...
        <p className="text-center text-xs text-gray-500">
          Sign in to access your personal tone library and rewriting playground
        </p>
      </div>
    </div>
  );
